  ...
  <div v-scroll-reveal>
    <section class="py-16 bg-white">
      <div class="max-w-5xl mx-auto px-4">
        <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Nourishing Every Body, Naturally.</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-16">
          <div class="bg-gray-200 rounded-lg overflow-hidden shadow-sm flex flex-col h-80"> <!-- Card fixed height -->
            ...
            <div class="p-4 flex-1 flex flex-col justify-center h-[40%]">
              <h3 class="font-semibold text-lg mb-1">Daily Gut Support</h3>
          ...
          <div class="bg-greenAccent rounded-lg overflow-hidden shadow-sm flex flex-col h-80">
            ...
            <div class="p-4 flex-1 flex flex-col justify-center h-[40%]">
              <h3 class="font-semibold text-lg mb-1">Convenient Wellness</h3>
              <p class="text-gray-600 text-sm">Just one spoonful blends into any routine—ideal for professionals, students, and anyone on-the-go.</p>
            </div>
          </div>
          <div class="bg-yellow-200 rounded-lg overflow-hidden shadow-sm flex flex-col h-80">
            <img src="@/assets/feature3.png" alt="Balanced & Regular"
              class="object-cover w-full h-[60%] flex-shrink-0" />
            <div class="p-4 flex-1 flex flex-col justify-center h-[40%]">
              <h3 class="font-semibold text-lg mb-1">Balanced & Regular</h3>
              <p class="text-gray-700 text-sm">Supports glucose control and bowel regularity—perfect for seniors and anyone seeking gentle, daily balance.</p>
            </div>
          </div>
        </div>
      </div>
